# Imágenes del Álbum — El Estado del Ser

Esta carpeta contiene los prompts para generar las imágenes del álbum usando herramientas de IA como Midjourney, DALL-E o Adobe Firefly.

## Estilo Visual General del Álbum

Todas las imágenes deben seguir esta estética coherente:
- **Paleta:** Tonos suaves, espirituales, etéreos (azules, dorados, verdes suaves, blancos)
- **Estilo:** Arte digital espiritual, acuarela digital, naturaleza sagrada
- **Atmósfera:** Paz, luz, expansión, naturaleza hawaiana y universal
- **Formato:** Horizontal (16:9 o 3:2) para el booklet del álbum
- **Resolución:** Mínimo 1920x1080 px

---

## Canciones 1-10 (Originales del Álbum)

Las imágenes originales de las canciones 1-10 provienen del documento fuente (`El_Estado_del_Ser.docx`) y deben ser reemplazadas o reproducidas con el mismo estilo. Los prompts sugeridos son:
...
transform into soft white light emanating from their chest. The figure has a peaceful, 
resolved expression. Sacred geometry subtly visible in background. Warm orange-gold-white 
color palette transitioning. Emotional transformation, fire to light, spiritual digital art, 
detailed, ethereal. Aspect ratio 16:9.
```
...
golden light enveloping both, tears on cheeks that transform into small light particles 
floating upward. Healing and forgiveness theme. Watercolor digital art style. Soft pastel 
colors: warm cream, rose gold, soft lavender. Sacred and intimate atmosphere, self-love 
...
blue-purple darkness into a vast warm golden light landscape. The doorway is ancient 
...
1. **Midjourney** — Mejor calidad artística. Copiar el prompt directamente en Discord
2. **DALL-E 3** (via ChatGPT) — Fácil de usar, buen resultado
3. **Adobe Firefly** — Excelente para imágenes sin copyright
4. **Stable Diffusion** — Gratuito, requiere instalación local
